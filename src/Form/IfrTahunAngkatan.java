   ...
   String vid_ta, vtahun_angkatan;
    ...
    private void setTabel(){
        ...
        tblthangkatan = new DefaultTableModel(null, kolom1){
            ...
            public boolean isCelledEditTable(int row, int col){
    ...
    private void aksiSimpan(){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Error method btnSimpan() : "+ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtIdTA, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
      if(txtIdTA.getText().equals("") || txtIdTA.getText().equals("AUTO")){
          JOptionPane.showMessageDialog(this, "Anda belum meilih data yang akan dihapus", "Informasi", 
                    JOptionPane.INFORMATION_MESSAGE);
      }else{
          aksiHapus();
      }
