        ...
        try{
            ...
            if(res.first()){
                ...
                if(vlev_user.equals("Administrator")){
                    ...
                    userKemahasiswaan();
                }else if(vlev_user.equals("Staf Bag. Pembayaran")){
                    userPembayaranUKT();
                }
            }else{
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbKeterangan, javax.swing.GroupLayout.PREFERRED_SIZE, 520, javax.swing.GroupLayout.PREFERRED_SIZE)
